...
namespace Diamond_Crush
{
    ...
    public partial class SignIn : Form
    {
        ...
        private void sign_in_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("If you want to play online, please wait till we complete online database.\n Now please return & press ESC to play offline.");
        }
        ...
        private void esc_Press(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (Char)Keys.Escape)
            {
                SignInOfflineAccount();

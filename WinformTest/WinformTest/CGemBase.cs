...
namespace WinformTest
{
    public class CGemBase
    {
        ...
        public bool _isSpecialGem = false;
        public bool _isFireGem = false;
        public bool _isVerticalElectric = false;
        public bool _isHorizontalElectric = false;
        ...
        public CGemBase(CGemBase root)
        {
            ...
            _isSpecialGem = root._isSpecialGem;
            _isFireGem = root._isFireGem;
            _isVerticalElectric = root._isVerticalElectric;
            _isHorizontalElectric = root._isHorizontalElectric;
        ...
        {
            _gemBox = new Rectangle(this._location.X, this._location.Y, 50, 50);
